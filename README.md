...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/stainless-sdks/apologist-php/issues/new).
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:stainless-sdks/apologist-php.git"
    }
  ],
  "require": {
...
See [the contributing documentation](https://github.com/stainless-sdks/apologist-php/tree/main/CONTRIBUTING.md).
